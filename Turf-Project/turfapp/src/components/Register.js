...
export default function Register() {
  ...
  const handleValidation = () => {
    ...
    if (!inpval.Name.trim()) {
      isValid = false;
      errors.Name = "Full Name is required";
    } else if (!/^[a-zA-Z\s]+$/.test(inpval.Name.trim())) {
      isValid = false;
    ...
    if (!inpval.age) {
      isValid = false;
      errors.age = "Age is required";
    } else if (isNaN(inpval.age) || inpval.age <= 0 || inpval.age > 120) {
      isValid = false;
    ...
    if (!inpval.username.trim()) {
      isValid = false;
      errors.username = "Username is required";
    } else if (!/^[a-zA-Z0-9]+$/.test(inpval.username)) {
      isValid = false;
    ...
    if (
      ...
      isValid = false;
      errors.password1 =
        "Password should be at least 8 characters long and include at least one special character, one letter, and one number";
    }
