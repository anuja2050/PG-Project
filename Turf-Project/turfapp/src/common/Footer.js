      ...
      <div className="row g-5 ">
        <div className="col-md-6 col-lg-6 col-xl-4 text-center">
          <div className="footer-item d-flex flex-column">
            <h4 className="mb-4 text-white footertext">Keep In Touch</h4>
            <Link to="">
              <i className="fas fa-home me-2" /> GreenBox ,dhule highway,jalgoan
            </Link>
            <Link to="">
              <i className="fas fa-envelope me-2" />Demo@gmail.com
            </Link>
            <Link to="">
              <i className="fas fa-phone me-2" />+91 9172343839
            </Link>
        ...
        <div className="col-md-6 col-lg-6 col-xl-4 text-center">
          <div className="footer-item d-flex flex-column">
            ...
            <i className="fas fa-angle-right me-2" /> AdminRegistration
            </Link>
            <Link to="/adminLogin">
    ...
    <div className="container">
      <div className="row">
        ...
        <p className='h5' style={{textAlign:"center", color:"white"}}>
          <Link to="#"><b> Turf Booking System</b></Link>&copy; Power By Team
          </p>
        </div>
